      ...
      <Parallax pages={3} className="bg-black">
        ...
        <ParallaxLayer offset={0} speed={0.6}>
          <div className="flex items-center justify-center h-screen">
            <h1 className={`text-5xl  ${myFont.className} font-bold text-white drop-shadow-lg`}>
              Welcome to 
              <br></br>
              the Story
              <br></br>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl">
      {[
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <Card className="rounded-3xl shadow-2xl bg-white/20 
        ...
        {/* <ParallaxLayer offset={2} speed={0.8}>
          <div className="flex items-center justify-center h-screen">
            <p className="text-3xl text-white max-w-2xl text-center drop-shadow-md">
              As you scroll, the video fades into images and text layers,
              keeping the parallax depth.
            </p>
          </div>
        </ParallaxLayer> */}
...
<ParallaxLayer offset={2} speed={0.2} factor={1.2}>
  <img
    src="/3.jpg"
    alt="Background"
    className="absolute inset-0 w-full h-full object-cover"
